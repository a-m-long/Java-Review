...
class EmployeeDemo {
	...
	public static void main(String args[]) {
		...
		for(Employee e : empList) {
			if(e.getEmpRole().equals("Manager")) {
				
				//Displaying Salary before Increment
				System.out.println(e.getEmpName()+" had salary before Increment: "+e.getSalary());
				
				//Increment Salary using Built-In Functional Interface "Function":
				Function<Integer,Integer> salaryIncrease = (sal) -> sal+5000;
				e.setSalary(salaryIncrease.apply(e.getSalary()));
				
				//Displaying Salary after Increment
				System.out.println(e.getEmpName()+" had salary after Increment: "+e.getSalary());
				System.out.println();
			}	
		}
